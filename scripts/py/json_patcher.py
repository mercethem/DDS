...
class JSONPatcher:
    ...
    def __init__(self, project_root: str = None):
        ...
        self.backup_suffix = ".json_patcher_backup"
...
'''
    ...
    def patch_publisher_file(self, publisher_file: str, json_file: str) -> bool:
        ...
        try:
            ...
            # Create backup
            backup_file = publisher_file + self.backup_suffix
            shutil.copy2(publisher_file, backup_file)
    ...
    def run(self) -> None:
        ...
        if total_patched > 0:
            print("\nNote: Backup files were created with .json_patcher_backup extension")
            print("You may need to install nlohmann/json library for C++ JSON support")
