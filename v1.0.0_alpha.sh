...
echo "  2. Test publishers: IDL/<MODULE>_idl_generated/build/<MODULE>main publisher"
echo "  3. Test subscribers: IDL/<MODULE>_idl_generated/build/<MODULE>main subscriber"
echo "  4. Run monitoring: monitoring/build/monitor"
echo "  5. Start demo dashboard: cd demo/run_demo && bash run_demo.sh"
echo ""
