...
/*!
 * @file CoreData4PublisherApp.cxx
 * This file contains the implementation of the publisher functions.
 *
 * This file was generated by the tool fastddsgen.
 */

#include "CoreData4PublisherApp.hpp"
...
#include "CoreData4PubSubTypes.hpp"
#include <filesystem>
#include <unistd.h>
#include <cstring>
...
CoreData4PublisherApp::CoreData4PublisherApp(
        const int& domain_id)
    : factory_(nullptr)
    ...
    , stop_(false)
{
    ...
    topic_ = participant_->create_topic("CoreData4Topic", type_.get_type_name(), topic_qos);
    if (topic_ == nullptr)
    {
...
void CoreData4PublisherApp::on_publication_matched(
        DataWriter* /*writer*/,
...
void CoreData4PublisherApp::run()
{
    while (!is_stopped())
    {
        if (publish())
...
bool CoreData4PublisherApp::publish()
{
    bool ret = false;
    ...
    if (!is_stopped())
    {
        ...
        if (!json_loaded) {
            ...
            std::vector<std::string> possible_paths = {
                "../../../scenarios/CoreData4.json",  // From IDL/<Module>_idl_generated/build/
                "../../scenarios/CoreData4.json",      // From IDL/<Module>_idl_generated/
                "scenarios/CoreData4.json"            // From project root
            };
            ...
            if (!file_found) {
                std::cerr << "Warning: Could not find CoreData4.json in any expected location, using default values" << std::endl;
            }
        }
...
bool CoreData4PublisherApp::is_stopped()
{
    return stop_.load();
}

void CoreData4PublisherApp::stop()
{
    stop_.store(true);
    cv_.notify_one();
}