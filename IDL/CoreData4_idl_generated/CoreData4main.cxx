        ...
        char** argv)
{
    ...
    int domain_id = 1;
    std::shared_ptr<CoreData4Application> app;
    ...
    else
    {
        try
        {
            app = CoreData4Application::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&CoreData4Application::run, app);
