        ...
        char** argv)
{
    ...
    int domain_id = 2;
    std::shared_ptr<IntelligenceApplication> app;
    ...
    else
    {
        try
        {
            app = IntelligenceApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&IntelligenceApplication::run, app);
