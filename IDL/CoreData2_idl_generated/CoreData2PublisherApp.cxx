...
/*!
 * @file CoreData2PublisherApp.cxx
 * This file contains the implementation of the publisher functions.
 *
 * This file was generated by the tool fastddsgen.
 */

#include "CoreData2PublisherApp.hpp"
...
#include "CoreData2PubSubTypes.hpp"
#include <filesystem>
#include <unistd.h>
#include <cstring>
...
CoreData2PublisherApp::CoreData2PublisherApp(
        const int& domain_id)
    : factory_(nullptr)
    ...
    , stop_(false)
{
    ...
    topic_ = participant_->create_topic("CoreData2Topic", type_.get_type_name(), topic_qos);
    if (topic_ == nullptr)
    {
...
void CoreData2PublisherApp::on_publication_matched(
        DataWriter* /*writer*/,
...
void CoreData2PublisherApp::run()
{
    while (!is_stopped())
    {
        if (publish())
...
bool CoreData2PublisherApp::publish()
{
    bool ret = false;
    ...
    if (!is_stopped())
    {
        ...
        if (!json_loaded) {
            ...
            std::vector<std::string> possible_paths = {
                "../../../scenarios/CoreData2.json",  // From IDL/<Module>_idl_generated/build/
                "../../scenarios/CoreData2.json",      // From IDL/<Module>_idl_generated/
                "scenarios/CoreData2.json"            // From project root
            };
            ...
            if (!file_found) {
                std::cerr << "Warning: Could not find CoreData2.json in any expected location, using default values" << std::endl;
            }
        }
...
bool CoreData2PublisherApp::is_stopped()
{
    return stop_.load();
}

void CoreData2PublisherApp::stop()
{
    stop_.store(true);
    cv_.notify_one();
}