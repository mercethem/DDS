        ...
        char** argv)
{
    ...
    int domain_id = 1;
    std::shared_ptr<CoreData2Application> app;
    ...
    else
    {
        try
        {
            app = CoreData2Application::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&CoreData2Application::run, app);
