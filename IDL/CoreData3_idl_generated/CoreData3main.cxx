        ...
        char** argv)
{
    ...
    int domain_id = 1;
    std::shared_ptr<CoreData3Application> app;
    ...
    else
    {
        try
        {
            app = CoreData3Application::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&CoreData3Application::run, app);
