        ...
        char** argv)
{
    ...
    int domain_id = 1;
    std::shared_ptr<CoreDataApplication> app;
    ...
    else
    {
        try
        {
            app = CoreDataApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&CoreDataApplication::run, app);
