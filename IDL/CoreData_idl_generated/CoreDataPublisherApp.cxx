...
/*!
 * @file CoreDataPublisherApp.cxx
 * This file contains the implementation of the publisher functions.
 *
 * This file was generated by the tool fastddsgen.
 */

#include "CoreDataPublisherApp.hpp"
...
CoreDataPublisherApp::CoreDataPublisherApp(
        const int& domain_id)
    : factory_(nullptr)
    ...
    , stop_(false)
{
    ...
    topic_ = participant_->create_topic("CoreDataTopic", type_.get_type_name(), topic_qos);
    if (topic_ == nullptr)
    {
...
void CoreDataPublisherApp::on_publication_matched(
        DataWriter* /*writer*/,
...
bool CoreDataPublisherApp::publish()
{
    bool ret = false;
    ...
    if (!is_stopped())
    {
        ...
        if (!json_loaded) {
            ...
            std::vector<std::string> possible_paths = {
                "../../../scenarios/CoreData.json",  // From IDL/<Module>_idl_generated/build/
                "../../scenarios/CoreData.json",      // From IDL/<Module>_idl_generated/
                "scenarios/CoreData.json"            // From project root
            };
            ...
            if (!file_found) {
                std::cerr << "Warning: Could not find CoreData.json in any expected location, using default values" << std::endl;
            }
        }
...
bool CoreDataPublisherApp::is_stopped()
{
    return stop_.load();
}

void CoreDataPublisherApp::stop()
{
    stop_.store(true);
    cv_.notify_one();
}