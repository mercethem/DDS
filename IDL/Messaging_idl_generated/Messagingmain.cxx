        ...
        char** argv)
{
    ...
    int domain_id = 3;
    std::shared_ptr<MessagingApplication> app;
    ...
    else
    {
        try
        {
            app = MessagingApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&MessagingApplication::run, app);
